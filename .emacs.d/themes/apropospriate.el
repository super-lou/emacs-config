...
(defmacro apropospriate-with-color-variables (variant &rest body)
  ...
  `(let* ((class '((class color) (min-colors 89)))
          (variant ,variant) ;;000000 282828 3a3a3a
          (base00   (if (eq variant 'light) "#FAFAFA" "#1c1c1c")) ;;424242
          (base01   (if (eq variant 'light) "#90A4AE" "#757575")) ;;757575
          (base02   (if (eq variant 'light) "#78909C" "#9E9E9E")) ;;9E9E9E
          (base03   (if (eq variant 'light) "#546E7A" "#E0E0E0")) ;;E0E0E0
...
(defun create-apropospriate-theme (variant theme-name)
  ...
  (apropospriate-with-color-variables variant
    (custom-theme-set-faces
     ...
     `(highlight ((,class (:background ,base00+2)))) ;; base00+1
     ...
     `(mode-line ((,class (:box (:line-width 4 :color ,base00-2 :style nil) ;; light-emphasis
                                :background ,base00-1 :foreground ,base03 ;;base00-2
     ...
     `(centaur-tabs-default ((t (:inherit default :foreground ,base02 :background "black" :box nil))))
     `(centaur-tabs-selected ((t (:foreground ,base02 :background ,base00 :box nil))))
     `(centaur-tabs-unselected ((t (:foreground ,base01 :background "#000000" :box nil))))
     `(centaur-tabs-selected-modified ((t (:foreground ,purple-1 :background ,base00 :box nil))))
     `(centaur-tabs-unselected-modified ((t (:foreground ,purple :background ,base00-1 :box nil))))
